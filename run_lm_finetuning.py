# -*- coding: utf-8 -*-
"""
Created on Fri Dec 18 15:44:13 2020
...
def load_and_cache_examples(args, tokenizer, evaluate=False):
    dataset = TextDataset(tokenizer, file_path=args.eval_data_file if evaluate else args.train_data_file, block_size=510)
    return dataset
...
def main():
    ...
    config = config_class.from_pretrained("dbmdz/bert-base-turkish-cased")
    tokenizer = tokenizer_class.from_pretrained("dbmdz/bert-base-turkish-cased")
    if args.block_size <= 0:
        args.block_size = tokenizer.max_len_single_sentence  # Our input block size will be the max possible for the model
    args.block_size = min(args.block_size, tokenizer.max_len_single_sentence)
    model = model_class.from_pretrained('dbmdz/bert-base-turkish-cased', config = config)
